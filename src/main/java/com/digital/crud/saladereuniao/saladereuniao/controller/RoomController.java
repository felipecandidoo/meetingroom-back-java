...
public class RoomController {
     ...
     @GetMapping("/rooms/{id}")
     public ResponseEntity<Room> getRoomById(@PathVariable(value = "id") long rommId)
         throws ResourceNotFoundException{
         Room room = roomRepository.findById(rommId)
                 .orElseThrow(() -> new ResourceNotFoundException("Room not found" + rommId));
